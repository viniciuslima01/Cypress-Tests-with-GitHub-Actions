...
<header>
  <h1>
    ActionController::InvalidAuthenticityToken
      in Spree::UserSessionsController#create
  </h1>
</header>
...
</div><div class="line active">          raise ActionController::InvalidAuthenticityToken
...
<pre>
<div class="line">
</div><div class="line">      def handle_unverified_request # :doc:
</div><div class="line active">        forgery_protection_strategy.new(self).handle_unverified_request
</div><div class="line">      end
</div><div class="line">
</div><div class="line">      #:nodoc:
</div>
</pre>
</td>
          </tr>
    ...
    <div class="source hidden" id="frame-source-2">
      <div class="info">
        Extracted source (around line <strong>#255</strong>):
      </div>
      <div class="data">
        <table cellpadding="0" cellspacing="0" class="lines">
          <tr>
...
<div class="line">      # clear run strategies and remove cached variables.
...
</div><div class="line active">        super # call the default behaviour which resets/nullifies/raises
    ...
    <div class="source hidden" id="frame-source-3">
      <div class="info">
        Extracted source (around line <strong>#238</strong>):
      </div>
      <div class="data">
        <table cellpadding="0" cellspacing="0" class="lines">
          <tr>
...
<div class="line">            end
...
</div><div class="line active">          handle_unverified_request
</div><div class="line">        end
</div><div class="line">      end
</div><div class="line">
</div>
    ...
    <div class="source hidden" id="frame-source-4">
      <div class="info">
        Extracted source (around line <strong>#426</strong>):
      </div>
      <div class="data">
        <table cellpadding="0" cellspacing="0" class="lines">
          <tr>
...
<div class="line">    included do
...
</div><div class="line active">                       terminator: -&gt;(controller, result_lambda) { result_lambda.call; controller.performed? },
    ...
    <div class="source hidden" id="frame-source-7">
      <div class="info">
        Extracted source (around line <strong>#199</strong>):
      </div>
      <div class="data">
        <table cellpadding="0" cellspacing="0" class="lines">
          <tr>
...
<div class="line">              unless halted
    ...
    <div class="source hidden" id="frame-source-8">
      <div class="info">
        Extracted source (around line <strong>#513</strong>):
      </div>
      <div class="data">
        <table cellpadding="0" cellspacing="0" class="lines">
          <tr>
...
<div class="line">    def process(*) #:nodoc:
    ...
    <div class="source hidden" id="frame-source-23">
      <div class="info">
        Extracted source (around line <strong>#104</strong>):
      </div>
      <div class="data">
        <table cellpadding="0" cellspacing="0" class="lines">
          <tr>
...
<td width="100%">
<pre>
<div class="line">            Rack::MiniProfiler.current.current_timer = current_timer = parent_timer.add_child(name)
</div><div class="line">            begin
</div><div class="line active">              self.send without_profiling, *args, &amp;orig
</div><div class="line">            ensure
</div><div class="line">              current_timer.record_time
</div><div class="line">              Rack::MiniProfiler.current.current_timer = parent_timer
</div>
</pre>
</td>
          </tr>
...
<pre>
<div class="line">
</div><div class="line">        SERVE = -&gt;(app, req) { app.serve req }
</div><div class="line active">        CALL  = -&gt;(app, req) { app.call req.env }
</div><div class="line">
</div><div class="line">        def initialize(app, constraints, strategy)
</div><div class="line">          # Unwrap Constraints objects. I don&#39;t actually think it&#39;s possible
</div>
</pre>
</td>
          </tr>
...
<td width="100%">
<pre>
<div class="line">          env[&#39;versioncake.context&#39;] = context
</div><div class="line">
</div><div class="line active">          status, headers, response = @app.call(env)
</div><div class="line">
</div><div class="line">          @response_service.inject_version(context, status, headers, response)
</div><div class="line">
</div>
</pre>
</td>
...
</div><div class="line active">      return @app.call(env) unless Bullet.enable?
</div><div class="line">
</div><div class="line">      Bullet.start_request
</div><div class="line">      status, headers, response = @app.call(env)
</div>
</pre>
</td>
          </tr>
...
<div class="line">
    ...
    <div class="source hidden" id="frame-source-82">
      <div class="info">
        Extracted source (around line <strong>#285</strong>):
      </div>
      <div class="data">
        <table cellpadding="0" cellspacing="0" class="lines">
          <tr>
...
<p><code>Rails.root: /spree/sandbox</code></p>
...
<div id="traces">
    ...
    <div id="Framework-Trace" style="display: none;">
      <pre><code><a class="trace-frames" data-frame-id="0" href="#">actionpack (5.2.1) lib/action_controller/metal/request_forgery_protection.rb:211:in `handle_unverified_request&#39;</a><br><a class="trace-frames" data-frame-id="1" href="#">actionpack (5.2.1) lib/action_controller/metal/request_forgery_protection.rb:243:in `handle_unverified_request&#39;</a><br><a class="trace-frames" data-frame-id="2" href="#">devise (4.4.3) lib/devise/controllers/helpers.rb:255:in `handle_unverified_request&#39;</a><br><a class="trace-frames" data-frame-id="3" href="#">actionpack (5.2.1) lib/action_controller/metal/request_forgery_protection.rb:238:in `verify_authenticity_token&#39;</a><br><a class="trace-frames" data-frame-id="4" href="#">activesupport (5.2.1) lib/active_support/callbacks.rb:426:in `block in make_lambda&#39;</a><br><a class="trace-frames" data-frame-id="5" href="#">activesupport (5.2.1) lib/active_support/callbacks.rb:198:in `block (2 levels) in halting&#39;</a><br><a class="trace-frames" data-frame-id="6" href="#">actionpack (5.2.1) lib/abstract_controller/callbacks.rb:34:in `block (2 levels) in &lt;module:Callbacks&gt;&#39;</a><br><a class="trace-frames" data-frame-id="7" href="#">activesupport (5.2.1) lib/active_support/callbacks.rb:199:in `block in halting&#39;</a><br><a class="trace-frames" data-frame-id="8" href="#">activesupport (5.2.1) lib/active_support/callbacks.rb:513:in `block in invoke_before&#39;</a><br><a class="trace-frames" data-frame-id="9" href="#">activesupport (5.2.1) lib/active_support/callbacks.rb:513:in `each&#39;</a><br><a class="trace-frames" data-frame-id="10" href="#">activesupport (5.2.1) lib/active_support/callbacks.rb:513:in `invoke_before&#39;</a><br><a class="trace-frames" data-frame-id="11" href="#">activesupport (5.2.1) lib/active_support/callbacks.rb:131:in `run_callbacks&#39;</a><br><a class="trace-frames" data-frame-id="12" href="#">actionpack (5.2.1) lib/abstract_controller/callbacks.rb:41:in `process_action&#39;</a><br><a class="trace-frames" data-frame-id="13" href="#">actionpack (5.2.1) lib/action_controller/metal/rescue.rb:22:in `process_action&#39;</a><br><a class="trace-frames" data-frame-id="14" href="#">actionpack (5.2.1) lib/action_controller/metal/instrumentation.rb:34:in `block in process_action&#39;</a><br><a class="trace-frames" data-frame-id="15" href="#">activesupport (5.2.1) lib/active_support/notifications.rb:168:in `block in instrument&#39;</a><br><a class="trace-frames" data-frame-id="16" href="#">activesupport (5.2.1) lib/active_support/notifications/instrumenter.rb:23:in `instrument&#39;</a><br><a class="trace-frames" data-frame-id="17" href="#">activesupport (5.2.1) lib/active_support/notifications.rb:168:in `instrument&#39;</a><br><a class="trace-frames" data-frame-id="18" href="#">actionpack (5.2.1) lib/action_controller/metal/instrumentation.rb:32:in `process_action&#39;</a><br><a class="trace-frames" data-frame-id="19" href="#">actionpack (5.2.1) lib/action_controller/metal/params_wrapper.rb:256:in `process_action&#39;</a><br><a class="trace-frames" data-frame-id="20" href="#">activerecord (5.2.1) lib/active_record/railties/controller_runtime.rb:24:in `process_action&#39;</a><br><a class="trace-frames" data-frame-id="21" href="#">actionpack (5.2.1) lib/abstract_controller/base.rb:134:in `process&#39;</a><br><a class="trace-frames" data-frame-id="22" href="#">actionview (5.2.1) lib/action_view/rendering.rb:32:in `process&#39;</a><br><a class="trace-frames" data-frame-id="23" href="#">rack-mini-profiler (1.0.0) lib/mini_profiler/profiling_methods.rb:104:in `block in profile_method&#39;</a><br><a class="trace-frames" data-frame-id="24" href="#">actionpack (5.2.1) lib/action_controller/metal.rb:191:in `dispatch&#39;</a><br><a class="trace-frames" data-frame-id="25" href="#">actionpack (5.2.1) lib/action_controller/metal.rb:252:in `dispatch&#39;</a><br><a class="trace-frames" data-frame-id="26" href="#">actionpack (5.2.1) lib/action_dispatch/routing/route_set.rb:52:in `dispatch&#39;</a><br><a class="trace-frames" data-frame-id="27" href="#">actionpack (5.2.1) lib/action_dispatch/routing/route_set.rb:34:in `serve&#39;</a><br><a class="trace-frames" data-frame-id="28" href="#">actionpack (5.2.1) lib/action_dispatch/routing/mapper.rb:18:in `block in &lt;class:Constraints&gt;&#39;</a><br><a class="trace-frames" data-frame-id="29" href="#">actionpack (5.2.1) lib/action_dispatch/routing/mapper.rb:48:in `serve&#39;</a><br><a class="trace-frames" data-frame-id="30" href="#">actionpack (5.2.1) lib/action_dispatch/journey/router.rb:52:in `block in serve&#39;</a><br><a class="trace-frames" data-frame-id="31" href="#">actionpack (5.2.1) lib/action_dispatch/journey/router.rb:35:in `each&#39;</a><br><a class="trace-frames" data-frame-id="32" href="#">actionpack (5.2.1) lib/action_dispatch/journey/router.rb:35:in `serve&#39;</a><br><a class="trace-frames" data-frame-id="33" href="#">actionpack (5.2.1) lib/action_dispatch/routing/route_set.rb:840:in `call&#39;</a><br><a class="trace-frames" data-frame-id="34" href="#">railties (5.2.1) lib/rails/engine.rb:524:in `call&#39;</a><br><a class="trace-frames" data-frame-id="35" href="#">railties (5.2.1) lib/rails/railtie.rb:190:in `public_send&#39;</a><br><a class="trace-frames" data-frame-id="36" href="#">railties (5.2.1) lib/rails/railtie.rb:190:in `method_missing&#39;</a><br><a class="trace-frames" data-frame-id="37" href="#">actionpack (5.2.1) lib/action_dispatch/routing/mapper.rb:19:in `block in &lt;class:Constraints&gt;&#39;</a><br><a class="trace-frames" data-frame-id="38" href="#">actionpack (5.2.1) lib/action_dispatch/routing/mapper.rb:48:in `serve&#39;</a><br><a class="trace-frames" data-frame-id="39" href="#">actionpack (5.2.1) lib/action_dispatch/journey/router.rb:52:in `block in serve&#39;</a><br><a class="trace-frames" data-frame-id="40" href="#">actionpack (5.2.1) lib/action_dispatch/journey/router.rb:35:in `each&#39;</a><br><a class="trace-frames" data-frame-id="41" href="#">actionpack (5.2.1) lib/action_dispatch/journey/router.rb:35:in `serve&#39;</a><br><a class="trace-frames" data-frame-id="42" href="#">actionpack (5.2.1) lib/action_dispatch/routing/route_set.rb:840:in `call&#39;</a><br><a class="trace-frames" data-frame-id="43" href="#">versioncake (3.4.0) lib/versioncake/rack/middleware.rb:17:in `call&#39;</a><br><a class="trace-frames" data-frame-id="44" href="#">bullet (5.8.0) lib/bullet/rack.rb:12:in `call&#39;</a><br><a class="trace-frames" data-frame-id="45" href="#">warden (1.2.7) lib/warden/manager.rb:36:in `block in call&#39;</a><br><a class="trace-frames" data-frame-id="46" href="#">warden (1.2.7) lib/warden/manager.rb:35:in `catch&#39;</a><br><a class="trace-frames" data-frame-id="47" href="#">warden (1.2.7) lib/warden/manager.rb:35:in `call&#39;</a><br><a class="trace-frames" data-frame-id="48" href="#">rack (2.0.5) lib/rack/tempfile_reaper.rb:15:in `call&#39;</a><br><a class="trace-frames" data-frame-id="49" href="#">rack (2.0.5) lib/rack/etag.rb:25:in `call&#39;</a><br><a class="trace-frames" data-frame-id="50" href="#">rack (2.0.5) lib/rack/conditional_get.rb:38:in `call&#39;</a><br><a class="trace-frames" data-frame-id="51" href="#">rack (2.0.5) lib/rack/head.rb:12:in `call&#39;</a><br><a class="trace-frames" data-frame-id="52" href="#">actionpack (5.2.1) lib/action_dispatch/http/content_security_policy.rb:18:in `call&#39;</a><br><a class="trace-frames" data-frame-id="53" href="#">rack (2.0.5) lib/rack/session/abstract/id.rb:232:in `context&#39;</a><br><a class="trace-frames" data-frame-id="54" href="#">rack (2.0.5) lib/rack/session/abstract/id.rb:226:in `call&#39;</a><br><a class="trace-frames" data-frame-id="55" href="#">actionpack (5.2.1) lib/action_dispatch/middleware/cookies.rb:670:in `call&#39;</a><br><a class="trace-frames" data-frame-id="56" href="#">activerecord (5.2.1) lib/active_record/migration.rb:559:in `call&#39;</a><br><a class="trace-frames" data-frame-id="57" href="#">actionpack (5.2.1) lib/action_dispatch/middleware/callbacks.rb:28:in `block in call&#39;</a><br><a class="trace-frames" data-frame-id="58" href="#">activesupport (5.2.1) lib/active_support/callbacks.rb:98:in `run_callbacks&#39;</a><br><a class="trace-frames" data-frame-id="59" href="#">actionpack (5.2.1) lib/action_dispatch/middleware/callbacks.rb:26:in `call&#39;</a><br><a class="trace-frames" data-frame-id="60" href="#">actionpack (5.2.1) lib/action_dispatch/middleware/executor.rb:14:in `call&#39;</a><br><a class="trace-frames" data-frame-id="61" href="#">actionpack (5.2.1) lib/action_dispatch/middleware/debug_exceptions.rb:61:in `call&#39;</a><br><a class="trace-frames" data-frame-id="62" href="#">web-console (3.7.0) lib/web_console/middleware.rb:135:in `call_app&#39;</a><br><a class="trace-frames" data-frame-id="63" href="#">web-console (3.7.0) lib/web_console/middleware.rb:22:in `block in call&#39;</a><br><a class="trace-frames" data-frame-id="64" href="#">web-console (3.7.0) lib/web_console/middleware.rb:20:in `catch&#39;</a><br><a class="trace-frames" data-frame-id="65" href="#">web-console (3.7.0) lib/web_console/middleware.rb:20:in `call&#39;</a><br><a class="trace-frames" data-frame-id="66" href="#">actionpack (5.2.1) lib/action_dispatch/middleware/show_exceptions.rb:33:in `call&#39;</a><br><a class="trace-frames" data-frame-id="67" href="#">railties (5.2.1) lib/rails/rack/logger.rb:38:in `call_app&#39;</a><br><a class="trace-frames" data-frame-id="68" href="#">railties (5.2.1) lib/rails/rack/logger.rb:26:in `block in call&#39;</a><br><a class="trace-frames" data-frame-id="69" href="#">activesupport (5.2.1) lib/active_support/tagged_logging.rb:71:in `block in tagged&#39;</a><br><a class="trace-frames" data-frame-id="70" href="#">activesupport (5.2.1) lib/active_support/tagged_logging.rb:28:in `tagged&#39;</a><br><a class="trace-frames" data-frame-id="71" href="#">activesupport (5.2.1) lib/active_support/tagged_logging.rb:71:in `tagged&#39;</a><br><a class="trace-frames" data-frame-id="72" href="#">railties (5.2.1) lib/rails/rack/logger.rb:26:in `call&#39;</a><br><a class="trace-frames" data-frame-id="73" href="#">sprockets-rails (3.2.1) lib/sprockets/rails/quiet_assets.rb:13:in `call&#39;</a><br><a class="trace-frames" data-frame-id="74" href="#">actionpack (5.2.1) lib/action_dispatch/middleware/remote_ip.rb:81:in `call&#39;</a><br><a class="trace-frames" data-frame-id="75" href="#">actionpack (5.2.1) lib/action_dispatch/middleware/request_id.rb:27:in `call&#39;</a><br><a class="trace-frames" data-frame-id="76" href="#">rack (2.0.5) lib/rack/method_override.rb:22:in `call&#39;</a><br><a class="trace-frames" data-frame-id="77" href="#">rack (2.0.5) lib/rack/runtime.rb:22:in `call&#39;</a><br><a class="trace-frames" data-frame-id="78" href="#">activesupport (5.2.1) lib/active_support/cache/strategy/local_cache_middleware.rb:29:in `call&#39;</a><br><a class="trace-frames" data-frame-id="79" href="#">actionpack (5.2.1) lib/action_dispatch/middleware/executor.rb:14:in `call&#39;</a><br><a class="trace-frames" data-frame-id="80" href="#">actionpack (5.2.1) lib/action_dispatch/middleware/static.rb:127:in `call&#39;</a><br><a class="trace-frames" data-frame-id="81" href="#">rack (2.0.5) lib/rack/sendfile.rb:111:in `call&#39;</a><br><a class="trace-frames" data-frame-id="82" href="#">rack-mini-profiler (1.0.0) lib/mini_profiler/profiler.rb:285:in `call&#39;</a><br><a class="trace-frames" data-frame-id="83" href="#">railties (5.2.1) lib/rails/engine.rb:524:in `call&#39;</a><br><a class="trace-frames" data-frame-id="84" href="#">puma (3.12.0) lib/puma/configuration.rb:225:in `call&#39;</a><br><a class="trace-frames" data-frame-id="85" href="#">puma (3.12.0) lib/puma/server.rb:658:in `handle_request&#39;</a><br><a class="trace-frames" data-frame-id="86" href="#">puma (3.12.0) lib/puma/server.rb:472:in `process_client&#39;</a><br><a class="trace-frames" data-frame-id="87" href="#">puma (3.12.0) lib/puma/server.rb:332:in `block in run&#39;</a><br><a class="trace-frames" data-frame-id="88" href="#">puma (3.12.0) lib/puma/thread_pool.rb:133:in `block in spawn_thread&#39;</a><br></code></pre>
    </div>
...
<p><b>Parameters</b>:</p> <pre>{&quot;token&quot;=&gt;&quot;e0c91507ca69781a03c62aabd83246ed75e8ed0f498a4652&quot;, &quot;spree_user&quot;=&gt;{&quot;password&quot;=&gt;&quot;[FILTERED]&quot;, &quot;email&quot;=&gt;&quot;spree@example.com&quot;}}
</pre>
